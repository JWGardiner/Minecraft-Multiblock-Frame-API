...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public LibrariesForLibs(DefaultVersionCatalog config, ProviderFactory providers) {
         ...
         */
        public Provider<MinimalExternalModuleDependency> getMinecraft() { return create("minecraft"); }

    /**
     * Returns the group of libraries at quilt
     */
    public QuiltLibraryAccessors getQuilt() { return laccForQuiltLibraryAccessors; }

    /**
     * Returns the group of libraries at quilted
     */
    public QuiltedLibraryAccessors getQuilted() { return laccForQuiltedLibraryAccessors; }
    ...
    public static class QuiltLibraryAccessors extends SubDependencyFactory {
        ...
        public QuiltLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getLoader() { return create("quilt.loader"); }

            /**
             * Creates a dependency provider for mappings (org.quiltmc:quilt-mappings)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getMappings() { return create("quilt.mappings"); }
    ...
    public static class QuiltedLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public QuiltedFabricLibraryAccessors getFabric() { return laccForQuiltedFabricLibraryAccessors; }
    ...
    public static class QuiltedFabricLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public QuiltedFabricApiLibraryAccessors getApi() { return laccForQuiltedFabricApiLibraryAccessors; }
    ...
    public static class QuiltedFabricApiLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public QuiltedFabricApiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> asProvider() { return create("quilted.fabric.api"); }

            /**
             * Creates a dependency provider for deprecated (org.quiltmc.quilted-fabric-api:quilted-fabric-api-deprecated)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getDeprecated() { return create("quilted.fabric.api.deprecated"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: minecraft (1.19)
         ...
         */
        public QuiltVersionAccessors getQuilt() { return vaccForQuiltVersionAccessors; }

        /**
         * Returns the group of versions at versions.quilted
         */
        public QuiltedVersionAccessors getQuilted() { return vaccForQuiltedVersionAccessors; }
    ...
    public static class QuiltVersionAccessors extends VersionFactory  {
        ...
        public QuiltVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: quilt.loader (0.17.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: quilt.mappings (1.19+build.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class QuiltedVersionAccessors extends VersionFactory  {
         ...
         */
        public QuiltedFabricVersionAccessors getFabric() { return vaccForQuiltedFabricVersionAccessors; }
    ...
    public static class QuiltedFabricVersionAccessors extends VersionFactory  {
        ...
        public QuiltedFabricVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: quilted.fabric.api (2.0.0-beta.5+0.57.0-1.19)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class BundleAccessors extends BundleFactory {
        private final QuiltedBundleAccessors baccForQuiltedBundleAccessors = new QuiltedBundleAccessors(providers, config);
         ...
         */
        public QuiltedBundleAccessors getQuilted() { return baccForQuiltedBundleAccessors; }

    }

    public static class QuiltedBundleAccessors extends BundleFactory {
        private final QuiltedFabricBundleAccessors baccForQuiltedFabricBundleAccessors = new QuiltedFabricBundleAccessors(providers, config);

        public QuiltedBundleAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of bundles at bundles.quilted.fabric
         */
        public QuiltedFabricBundleAccessors getFabric() { return baccForQuiltedFabricBundleAccessors; }

    }

    public static class QuiltedFabricBundleAccessors extends BundleFactory {

        public QuiltedFabricBundleAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
             ...
             */
            public Provider<ExternalModuleDependencyBundle> getApi() { return createBundle("quilted.fabric.api"); }

    }

    public static class PluginAccessors extends PluginFactory {
        private final QuiltPluginAccessors baccForQuiltPluginAccessors = new QuiltPluginAccessors(providers, config);

        public PluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of bundles at plugins.quilt
         */
        public QuiltPluginAccessors getQuilt() { return baccForQuiltPluginAccessors; }
